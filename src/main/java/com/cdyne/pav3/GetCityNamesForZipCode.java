 ...
 */
            ...
            /**
            *  GetCityNamesForZipCode bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCityNamesForZipCode
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetCityNamesForZipCode",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetCityNamesForZipCode",
    ...
    public static class Factory{
        ...
        */
        public static GetCityNamesForZipCode parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCityNamesForZipCode object =
                new GetCityNamesForZipCode();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetCityNamesForZipCode".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCityNamesForZipCode)com.cdyne.pav3.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
