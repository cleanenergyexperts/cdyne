...
/**
 * GetCongressionalDistrictByZip.java
 *
 ...
 */
            ...
            /**
            *  GetCongressionalDistrictByZip bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCongressionalDistrictByZip
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetCongressionalDistrictByZip",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetCongressionalDistrictByZip",
    ...
    public static class Factory{
        ...
        */
        public static GetCongressionalDistrictByZip parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCongressionalDistrictByZip object =
                new GetCongressionalDistrictByZip();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetCongressionalDistrictByZip".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCongressionalDistrictByZip)com.cdyne.pav3.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://pav3.cdyne.com","ZipCode").equals(reader.getName())){
