 ...
 */
            ...
            /**
            *  GetZipCodesForFips bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetZipCodesForFips
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetZipCodesForFips",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetZipCodesForFips",
    ...
    public static class Factory{
        ...
        */
        public static GetZipCodesForFips parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetZipCodesForFips object =
                new GetZipCodesForFips();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetZipCodesForFips".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetZipCodesForFips)com.cdyne.pav3.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://pav3.cdyne.com","Fips").equals(reader.getName())){
