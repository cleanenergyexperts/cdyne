...
/**
 * GetZipCodesForCityAndState.java
 *
 ...
 */
            ...
            /**
            *  GetZipCodesForCityAndState bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetZipCodesForCityAndState
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetZipCodesForCityAndState",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetZipCodesForCityAndState",
    ...
    public static class Factory{
        ...
        */
        public static GetZipCodesForCityAndState parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetZipCodesForCityAndState object =
                new GetZipCodesForCityAndState();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetZipCodesForCityAndState".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetZipCodesForCityAndState)com.cdyne.pav3.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://pav3.cdyne.com","City").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://pav3.cdyne.com","State").equals(reader.getName())){
