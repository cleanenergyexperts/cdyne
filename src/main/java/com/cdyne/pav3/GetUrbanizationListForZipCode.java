...
/**
 * GetUrbanizationListForZipCode.java
 *
 ...
 */
            ...
            /**
            *  GetUrbanizationListForZipCode bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetUrbanizationListForZipCode
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetUrbanizationListForZipCode",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetUrbanizationListForZipCode",
    ...
    public static class Factory{
        ...
        */
        public static GetUrbanizationListForZipCode parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUrbanizationListForZipCode object =
                new GetUrbanizationListForZipCode();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetUrbanizationListForZipCode".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUrbanizationListForZipCode)com.cdyne.pav3.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
